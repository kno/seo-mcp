...
| e   | 5.1                                                                                                                                                                                                                                                                                                                                |
| f   | 2.3                                                                                                                                                                                                                                                                                                                                |
| g   | (design row g — `x-seo-active-site` header spoofing) — closed by the post-Phase-6 follow-up wiring `get_keyword_metrics`/`discover_keywords` to `buildServer(env, {activeSiteUrl})` -> `resolveSiteCredentials`; absent-header ⇒ global tier is `test/mcp-tools/keywords-active-site.test.ts` and `test/index-active-site.test.ts` |
| h   | 4a.7                                                                                                                                                                                                                                                                                                                               |
| i   | 3.5, 6.4                                                                                                                                                                                                                                                                                                                           |
| j   | 1.4                                                                                                                                                                                                                                                                                                                                |
| k   | 5.2                                                                                                                                                                                                                                                                                                                                |
